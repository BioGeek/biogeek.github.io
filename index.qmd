...
Built a TensorFlow Extended production pipeline training deep-learning models on multispectral images to detect and classify melanoma skin cancers for [Demetra](https://www.inthepocket.com/work/barco-demetra), Barco's dermatology imaging device, engineered to the standards of regulated medical industries (FDA approval). Worked across the research, cloud-backend and mobile/web frontend teams.

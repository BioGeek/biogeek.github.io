...
```{=html}
<p class="pub-metrics"><!-- OPENALEX:START --><strong>61</strong> citations &middot; <span class="h-index-term" tabindex="0" role="note" aria-label="If you have an h-index of 4, it means you have published at least 4 papers that have each received 4 or more citations" data-tip="If you have an h-index of 4, it means you have published at least 4 papers that have each received 4 or more citations">h-index</span> <strong>4</strong> &middot; <span class="h-index-term" tabindex="0" role="note" aria-label="If you have an i10-index of 3, it means you have published 3 papers that have each received 10 or more citations" data-tip="If you have an i10-index of 3, it means you have published 3 papers that have each received 10 or more citations">i10</span> <strong>3</strong> &middot; <span style="color:#888;font-size:.8rem">via OpenAlex, Jul 2026</span><!-- OPENALEX:END --></p>
```

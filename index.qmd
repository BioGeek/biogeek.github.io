...
<div class="hiring">
  <p class="hiring-status"><strong>Currently looking for roles in AI for science</strong> (biology, proteomics, drug discovery, protein design, foundation models): Manager of Machine Learning · Member of Technical Staff · Head of Artificial Intelligence · Chief Technology Officer.</p>
  ...
  <ul class="proof">
    <li>Published InstaNovo (a transformer model) and InstaNovo+ (a diffusion model) for <i>de novo</i> peptide sequencing in <strong>Nature Machine Intelligence</strong>, and InstaNovo-P (a model finetuned on phosphoproteomics data) in <strong>Nature Communications</strong>.</li>
...
<!-- PUBCOUNT:START -->9<!-- PUBCOUNT:END --> publications, including papers published in *Nature Machine Intelligence* and *Nature Communications*.

```{=html}
<p class="pub-metrics"><!-- OPENALEX:START --><strong>104</strong> citations &middot; <span class="h-index-term" tabindex="0" role="note" aria-label="If you have an h-index of 5, it means you have published at least 5 papers that have each received 5 or more citations" data-tip="If you have an h-index of 5, it means you have published at least 5 papers that have each received 5 or more citations">h-index</span> <strong>5</strong> &middot; <span class="h-index-term" tabindex="0" role="note" aria-label="If you have an i10-index of 4, it means you have published 4 papers that have each received 10 or more citations" data-tip="If you have an i10-index of 4, it means you have published 4 papers that have each received 10 or more citations">i10</span> <strong>4</strong> &middot; <span style="color:#888;font-size:.8rem"><a href="https://openalex.org/works?filter=author.orcid:0000-0003-4480-5567">via OpenAlex</a>, Sep 2026</span><!-- OPENALEX:END --></p>
```
...
<div class="pub-card flagship" id="pub-instanovo">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">A transformer (InstaNovo) and a diffusion model (InstaNovo+) that read peptide sequences straight from mass spectra with no reference database. Trained on up to 28 million spectra and validated on real datasets: improving therapeutic sequencing coverage, discovering novel peptides and detecting previously unreported organisms.</div>
    <div class="pub-badges">
      ...
      <a href="https://github.com/instadeepai/InstaNovo"><i class="bi bi-github"></i> Code (131 <i class="bi bi-star-fill"></i>)</a>
...
<div class="pub-card">
  <a class="pub-thumb" href="https://doi.org/10.1038/s41467-026-75138-x">
    <img width="480" height="405" loading="lazy" src="images/publications/instanovo-p_figure1.png" alt="InstaNovo-P figure 1" />
  </a>
  <div class="pub-body">
    <div class="pub-title"><a href="https://doi.org/10.1038/s41467-026-75138-x">InstaNovo-P: a <i>de novo</i> peptide sequencing model for phosphoproteomics</a></div>
    <div class="pub-authors">J. Lauridsen*, V. Canbay*, <span class="author-ellipsis" role="button" tabindex="0" aria-expanded="false" aria-label="Full author list: J. Lauridsen*, V. Canbay*, R. Catzel*, P. Ramasamy*, A. Mabona, K. Eloff, P. Fullwood, J. Ferguson, A. Kirketerp-Møller, I. S. Goldschmidt, T. Claeys, S. van Puyenbroeck, N. Lopez Carranza, E. M. Schoof, L. Martens, J. Van Goey, C. Francavilla, T. P. Jenkins†, K. Kalogeropoulos†" data-authors="J. Lauridsen*, V. Canbay*, R. Catzel*, P. Ramasamy*, A. Mabona, K. Eloff, P. Fullwood, J. Ferguson, A. Kirketerp-Møller, I. S. Goldschmidt, T. Claeys, S. van Puyenbroeck, N. Lopez Carranza, E. M. Schoof, L. Martens, J. Van Goey, C. Francavilla, T. P. Jenkins†, K. Kalogeropoulos†">...</span> <strong>J. Van Goey</strong>, <span class="author-ellipsis" role="button" tabindex="0" aria-expanded="false" aria-label="Full author list: J. Lauridsen*, V. Canbay*, R. Catzel*, P. Ramasamy*, A. Mabona, K. Eloff, P. Fullwood, J. Ferguson, A. Kirketerp-Møller, I. S. Goldschmidt, T. Claeys, S. van Puyenbroeck, N. Lopez Carranza, E. M. Schoof, L. Martens, J. Van Goey, C. Francavilla, T. P. Jenkins†, K. Kalogeropoulos†" data-authors="J. Lauridsen*, V. Canbay*, R. Catzel*, P. Ramasamy*, A. Mabona, K. Eloff, P. Fullwood, J. Ferguson, A. Kirketerp-Møller, I. S. Goldschmidt, T. Claeys, S. van Puyenbroeck, N. Lopez Carranza, E. M. Schoof, L. Martens, J. Van Goey, C. Francavilla, T. P. Jenkins†, K. Kalogeropoulos†">...</span> K. Kalogeropoulos†</div>
    <div class="pub-venue"><span class="venue-name">Nature Communications</span> · 2026</div>
    <div class="pub-summary">Extends InstaNovo to phosphoproteomics: sequencing phosphopeptides and localising the modified site directly from spectra, where database methods often struggle.</div>
    <div class="pub-badges">
      <a class="badge-primary" href="https://doi.org/10.1038/s41467-026-75138-x"><i class="bi bi-journal-text"></i> Nature Commun.</a>
      ...
      <a href="files/bib/lauridsen2026instanovo_p.bib" download><i class="bi bi-quote"></i> BibTeX</a>
    </div>
  </div>
</div>

<div class="pub-card" id="pub-instanovo-fm">
  <a class="pub-thumb" href="https://doi.org/10.64898/2026.09.03.747733">
    <img width="480" height="585" loading="lazy" src="images/publications/instanovo-fm_figure1.png" alt="InstaNovo-FM figure 1" />
  </a>
  <div class="pub-body">
    <div class="pub-title"><a href="https://doi.org/10.64898/2026.09.03.747733">Learning from tandem mass spectra at scale with a self-supervised foundation model for proteomics</a></div>
    <div class="pub-authors">M. Nieuwoudt*, M. Reverenna*, <span class="author-ellipsis" role="button" tabindex="0" aria-expanded="false" aria-label="Full author list: M. Nieuwoudt*, M. Reverenna*, D. Patel*, R. Catzel, I. H. J. Houngue, J. Daniel, K. Eloff, A. Santos, N. Lopez Carranza, T. P. Jenkins, J. Van Goey†, K. Kalogeropoulos†" data-authors="M. Nieuwoudt*, M. Reverenna*, D. Patel*, R. Catzel, I. H. J. Houngue, J. Daniel, K. Eloff, A. Santos, N. Lopez Carranza, T. P. Jenkins, J. Van Goey†, K. Kalogeropoulos†">...</span> <strong>J. Van Goey</strong><span class="author-role" aria-label="co-senior author" title="co-senior author">†</span>, K. Kalogeropoulos<span class="author-role" aria-label="co-senior author" title="co-senior author">†</span></div>
    <div class="pub-venue"><span class="venue-name">bioRxiv</span> (preprint) · 2026</div>
    <div class="pub-summary">InstaNovo-FM, a self-supervised foundation model for bottom-up proteomics: an encoder-only transformer pretrained on 1.47 billion tandem mass spectra by physics-aware masked reconstruction, whose embeddings transfer to <i>de novo</i> sequencing, database-free identification and analytical run classification.</div>
    <div class="pub-badges">
      <a class="badge-primary" href="https://doi.org/10.64898/2026.09.03.747733"><i class="bi bi-file-earmark-text"></i> bioRxiv</a>
      <a href="https://github.com/instadeepai/InstaNovo-FM"><i class="bi bi-github"></i> Code</a>
      <a href="https://colab.research.google.com/github/instadeepai/InstaNovo-FM/blob/main/notebooks/getting_started_with_instanovo_fm.ipynb"><i class="bi bi-journal-code"></i> Getting started</a>
      <a href="https://huggingface.co/spaces/InstaDeepAI/InstaNovo-FM"><i class="bi bi-play-circle"></i> Demo</a>
      <a href="https://instadeepai.github.io/InstaNovo-FM"><i class="bi bi-graph-up"></i> UMAP explorer</a>
      <a href="https://huggingface.co/datasets/InstaDeepAI/InstaNovo"><i class="bi bi-database"></i> Datasets</a>
      <a href="https://huggingface.co/datasets/InstaDeepAI/InstaNovo-FM-embeddings"><i class="bi bi-grid-3x3"></i> Embeddings</a>
      <a href="files/bib/nieuwoudt2026instanovo_fm.bib" download><i class="bi bi-quote"></i> BibTeX</a>
    </div>
  </div>
</div>
...
<div class="pub-card" id="pub-winnow">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">A rescoring and false-discovery-rate framework that turns raw <i>de novo</i> predictions into calibrated, trustworthy peptide identifications.</div>
    <div class="pub-badges">
...
<div class="pub-card">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">A community, continuously updated benchmark that evaluates deep-learning <i>de novo</i> sequencing tools on shared datasets under one common protocol.</div>
    <div class="pub-badges">
...
<div class="pub-card" id="pub-instanexus">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">Assembles overlapping <i>de novo</i> peptide reads into full-length sequences, enabling database-free, direct protein sequencing.</div>
    <div class="pub-badges">
...
<div class="pub-card">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">A framework for bringing AI models into mass-spectrometry database search, and how the approach scales.</div>
    <div class="pub-badges">
...
<div class="pub-card">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">A community perspective on building open-source, FAIR (findable, accessible, interoperable, reusable) software for the proteomics field.</div>
    <div class="pub-badges">
...
<div class="pub-card">
  ...
  <div class="pub-body">
    ...
    <div class="pub-summary">An assembly-free, k-mer-based method for comparing bacterial whole-genome sequencing samples by their SNPs.</div>
    <div class="pub-badges">
...
<div class="media-wrap">
  <div class="altmetric-box">
    ...
    <div class="metric-extra">
      <span class="__dimensions_badge_embed__" data-doi="10.1038/s42256-025-01019-5" data-style="small_circle"></span>
      <div class="altmetric-caption">Dimensions citations</div>
    </div>

    <div class="metric-extra">
      <div class="bip-embed" data-doi="10.1038/s42256-025-01019-5"></div>
      <div class="altmetric-caption">BIP! impact indicators</div>
    </div>

    <script async src="https://badge.dimensions.ai/badge.js" charset="utf-8"></script>
    <script async src="https://cdn.jsdelivr.net/gh/athenarc/bip-plugin@main/embed.min.js"></script>
  </div>
  <div class="coverage">
...
<!--
  READY FOR LATER: an "InstaNovo-FM in the news" section, mirroring the
  InstaNovo one above. Only a few LinkedIn posts so far, so it is kept
  commented out. To enable: remove the surrounding comment wrapper, flesh
  out the coverage, and add an "In the news" button linking to
  #instanovo-fm-in-the-news on the InstaNovo-FM card.

<section id="instanovo-fm-in-the-news">
  <h3>InstaNovo-FM in the news</h3>
  <div class="coverage">
    <strong>On LinkedIn</strong>
    <ul class="coverage-grid">
      <li><a href="https://www.linkedin.com/posts/konstantinos-kalogeropoulos-57a265167_proteomics-activity-7503503849152860160-tSwy/">K. Kalogeropoulos</a></li>
      <li><a href="https://www.linkedin.com/posts/jeroenvangoey_proteomics-activity-7503469354999709696-weew">J. Van Goey</a></li>
      <li><a href="https://www.linkedin.com/posts/qing-zhang-66482792_learning-from-tandem-mass-spectra-at-scale-activity-7502811920438177792-E_8M">Q. Zhang</a></li>
    </ul>
  </div>
</section>
-->
...
<div class="relocation">
  <i class="bi bi-geo-alt-fill"></i> <strong>Location &amp; availability:</strong> My family and I moved from Belgium to South Africa in 2023. We plan to relocate again around early 2027 to either Europe or the USA. So I'm open to <strong>remote-first roles now</strong>, or <strong>hybrid / on-site roles in Europe or America from 2027</strong>.
</div>

<div class="exp-filter" role="group" aria-label="Filter experience by focus area">
  <input type="radio" name="exp-filter" id="exp-filter-all" class="exp-filter-input" checked>
  <label for="exp-filter-all" class="exp-filter-btn">All</label>

  <input type="radio" name="exp-filter" id="exp-filter-research-ml" class="exp-filter-input">
  <label for="exp-filter-research-ml" class="exp-filter-btn">Research &amp; ML</label>

  <input type="radio" name="exp-filter" id="exp-filter-engineering-mlops" class="exp-filter-input">
  <label for="exp-filter-engineering-mlops" class="exp-filter-btn">Engineering &amp; MLOps</label>

  <input type="radio" name="exp-filter" id="exp-filter-leadership-people" class="exp-filter-input">
  <label for="exp-filter-leadership-people" class="exp-filter-btn">Leadership &amp; People</label>

  <input type="radio" name="exp-filter" id="exp-filter-bioinformatics-domain" class="exp-filter-input">
  <label for="exp-filter-bioinformatics-domain" class="exp-filter-btn">Bioinformatics &amp; Domain</label>
</div>
```

::: {.experience-entry data-tags="research-ml engineering-mlops leadership-people"}
...
```{=html}
<ul>
<li data-tags="leadership-people research-ml"><strong>Tech lead and hiring manager</strong> for two cross-disciplinary <strong>ML research teams</strong> of about 5 to 8 people: <em>de novo</em> peptide sequencing (with the Technical University of Denmark) and signal-peptide design for secretion efficiency (with BioNTech).</li>
<li data-tags="research-ml engineering-mlops">Set <strong>research direction</strong> and take models <strong>from research to production</strong> (InstaNovo is available to commercial customers on <strong><a href="https://deepchain.bio/sequence-peptideswithout-reference-databases/">DeepChain</a></strong>), balancing scientific rigour with reliable, maintainable engineering.</li>
<li data-tags="research-ml">Delivered a <strong>client collaboration with <a href="https://instadeep.com/2024/06/syngenta-and-instadeep-collaborate-to-accelerate-crops-seeds-trait-research-using-ai-large-language-models/">Syngenta</a></strong>, applying <strong>genomic language models</strong> (AgroNT, a Nucleotide Transformer trained on ~10.5 million genomic sequences spanning trillions of base pairs across 48 plant species) to accelerate crop trait research.</li>
<li data-tags="leadership-people"><strong>Lead the BioAI team</strong> of InstaDeep’s Cape Town office and serve as the office’s <strong>site manager</strong> (an office of about 25 people); responsible for <strong>hiring and growing</strong> the BioAI teams across the Cape Town and Kigali offices.</li>
<li data-tags="engineering-mlops">Directed the team’s <strong>ML engineering foundations</strong>: scalable, Transformer-based libraries (Python / PyTorch) for large-scale training on InstaDeep’s <a href="https://instadeep.com/2024/10/instadeep-unveils-near-exascale-supercomputer-kyber-boosting-ai-capabilities/"><strong>Kyber</strong></a> (~500 PFLOPs) and EuroHPC’s <a href="https://web.archive.org/web/20260607175948/https://www.bsc.es/marenostrum/marenostrum-5"><strong>MareNostrum 5</strong></a> (260 PFLOPs) supercomputers, and the cloud (AWS, GCP).</li>
</ul>
```
:::

::: {.experience-entry data-tags="engineering-mlops"}
...
```{=html}
<ul>
<li data-tags="engineering-mlops">Built a TensorFlow Extended production pipeline (orchestrated with Apache Airflow) training deep-learning models on multispectral images to detect and classify melanoma skin cancers for <a href="https://www.inthepocket.com/work/barco-demetra">Demetra</a>, Barco’s dermatology imaging device.</li>
<li data-tags="engineering-mlops">Engineered the pipeline with <strong>end-to-end data and model lineage tracking</strong> to deliver the traceability and reproducibility that <strong>regulated medical industries (FDA approval)</strong> require.</li>
<li data-tags="engineering-mlops">Worked across the research, cloud-backend and mobile/web frontend teams.</li>
</ul>
```
:::

::: {.experience-entry data-tags="bioinformatics-domain leadership-people research-ml"}
...
```{=html}
<ul>
<li data-tags="bioinformatics-domain">Owned the <strong><a href="work/r-python-platforms.qmd">Python/R data-analysis platform</a></strong> used by <strong>480 researchers and data scientists</strong>.</li>
<li data-tags="research-ml bioinformatics-domain">Sample use case: applying <strong>deep learning</strong> to annotate vascular bundles in wheat <span class="term-tip" tabindex="0" role="note" aria-label="The uppermost internode of a wheat stem, supporting the grain-bearing spike; the vascular bundles visible in its cross-section are linked to grain yield." data-tip="The uppermost internode of a wheat stem, supporting the grain-bearing spike; the vascular bundles visible in its cross-section are linked to grain yield.">peduncle</span> cross-sections (a yield-linked trait) with the model running on the on-premise GPU cluster.</li>
<li data-tags="leadership-people bioinformatics-domain">Delivered <strong>training</strong> (NumPy, pandas, BioPython, …) and <strong>mentoring</strong> across the company’s internal research community.</li>
<li data-tags="bioinformatics-domain">Provided technical support, proactive monitoring and root-cause analysis.</li>
</ul>
```
:::

::: {.experience-entry data-tags="bioinformatics-domain"}
...
<div class="pub-list">
  ...
  <div class="pub-card">
  <a class="pub-thumb" href="projects/self-driving-rc-car.html">
    <img width="480" height="300" loading="lazy" src="images/projects/self-driving-rc-car.jpg" alt="The assembled DonkeyCar with a Jetson Nano on a 3D-printed cage" />
  </a>
  <div class="pub-body">
    <div class="pub-title"><a href="projects/self-driving-rc-car.html">Self-driving RC car</a></div>
    <p>Turning a 1/16-scale RC car into an autonomous car as a hands-on testbed for modern edge ML. Experimenting with training policies in simulation and deploying them to a Jetson Nano, with a Coral Edge TPU planned. An ongoing build, documented as I go.</p>
    <div class="pub-badges">
      <a class="badge-primary" href="projects/self-driving-rc-car.html"><i class="bi bi-car-front"></i> Project overview</a>
      <a href="writing.html#category=jetson"><i class="bi bi-journal-text"></i> Progress log</a>
    </div>
  </div>
</div>
...
<div class="pub-card">
  ...
  <div class="pub-body">
    <div class="pub-title"><a href="https://jeroen.vangoey.be/awesome_de_novo_peptide_sequencing/">Awesome <i>De Novo</i> Peptide Sequencing</a></div>
...
<div class="pub-card">
  <a class="pub-thumb" href="photography/">
    <img width="480" height="320" loading="lazy" src="/images/photography/pregnancy/01-w600.jpg" alt="Maternity photograph by Jeroen Van Goey" />
  </a>
  <div class="pub-body">
    <div class="pub-title"><a href="photography/">Photography</a></div>
    <p>My portfolio of portrait, wedding, maternity, boudoir, landscape and long-exposure work. A hand-picked selection spanning intimate studio sessions and work out in the field.</p>
    <div class="pub-badges">
...
<i class="bi bi-calendar3"></i> _2025–2026_\
<img width="900" height="600" src="images/flags/za.svg" class="flag-icon" alt="South Africa">AIMS South Africa, with InstaDeep\
Co-supervised several African Institute for Mathematical Sciences (AIMS) South Africa Master's students at InstaDeep on de novo peptide sequencing and proteomics: mechanistic interpretability of InstaNovo (sparse autoencoders), self-supervised diffusion models for mass spectrometry, contrastive-predictive-coding pretraining of a mass-spectra encoder, fine-tuning InstaNovo on glycosylation data, and an AI-native framework for large-scale proteomic database search via contrastive joint embeddings and a transformer-based scoring function.

```{=html}
<div class="pub-badges">
  <a href="https://www.linkedin.com/posts/mohammed-nagi-418924236_airesearch-machinelearning-mechanisticinterpretability-ugcPost-7480980239163117568-KkZc/"><i class="bi bi-linkedin"></i> Interpretability (SAEs)</a>
  <a href="https://www.linkedin.com/posts/vicent-mwanda-6b278313a_aims-googledeepmind-artificialintelligence-ugcPost-7480934646164340736-RRSL/"><i class="bi bi-linkedin"></i> Diffusion for MS</a>
  <a href="https://www.linkedin.com/feed/update/urn:li:activity:7491538591270211584/"><i class="bi bi-linkedin"></i> AI-assisted database search</a>
</div>
<div class="pub-badges thesis-row">
  <a href="files/theses/interpretability-sparse-autoencoders-instanovo.pdf"><i class="bi bi-file-earmark-pdf"></i> Interpretability (SAEs) thesis</a>
  <a href="files/theses/diffusion-foundation-model-mass-spectrometry.pdf"><i class="bi bi-file-earmark-pdf"></i> Diffusion for MS thesis</a>
  <a href="files/theses/ai-guided-database-search-proteomics.pdf"><i class="bi bi-file-earmark-pdf"></i> AI-assisted database search thesis</a>
  <a href="files/theses/spectra-encoder-cpc-pretraining.pdf"><i class="bi bi-file-earmark-pdf"></i> Spectra-encoder pretraining thesis</a>
  <a href="files/theses/glyco-finetuning-instanovo.pdf"><i class="bi bi-file-earmark-pdf"></i> Glyco fine-tuning thesis</a>
</div>
```

**DTU PhD research stay**\
<i class="bi bi-calendar3"></i> _2026_\
<img width="900" height="600" src="images/flags/za.svg" class="flag-icon" alt="South Africa">InstaDeep, Cape Town, South Africa\
Mentored a PhD student from the Technical University of Denmark (DTU) during a 3-month research stay at InstaDeep in Cape Town, part of an ongoing collaboration between DTU and InstaDeep. Together we developed InstaNovo-FM, a self-supervised foundation model for proteomics, and put rigorous software-engineering practices in place.

```{=html}
<div class="pub-badges">
  <a href="https://doi.org/10.64898/2026.09.03.747733"><i class="bi bi-file-earmark-text"></i> InstaNovo-FM (bioRxiv)</a>
  <a href="https://www.linkedin.com/posts/welcome-back-to-two-of-our-phd-students-ugcPost-7485665343999287296-Pqac/"><i class="bi bi-linkedin"></i> Proteomics foundation model</a>
</div>
```
...
<div class="pub-badges">
  ...
  <a href="https://www.linkedin.com/posts/yousra-farhani-7a416219a_machinelearning-biology-dli23-ugcPost-7109547765549936640-Y4t3/"><i class="bi bi-linkedin"></i> Practical highlights</a>
</div>
```
...
```{=html}
<div class="pub-badges">
  <a href="work/r-python-platforms.html"><i class="bi bi-easel"></i> R &amp; Python platforms</a>
</div>
```
...
**Scale**\
<i class="bi bi-gpu-card skill-glyph" aria-hidden="true"></i>Distributed GPU training, HPC clusters (InstaDeep's [Kyber](https://instadeep.com/2024/10/instadeep-unveils-near-exascale-supercomputer-kyber-boosting-ai-capabilities/) and EuroHPC's [MareNostrum 5](https://web.archive.org/web/20260607175948/https://www.bsc.es/marenostrum/marenostrum-5))
...
<div class="social-links footer-social">
  ...
  <a href="https://www.instagram.com/jeroenvangoey/"><i class="bi bi-instagram"></i> Instagram</a>
  ...
  <a href="https://openreview.net/profile?id=%7EJeroen_Van_Goey1"><i class="bi bi-journal-text"></i> OpenReview</a>
  <a href="https://www.semanticscholar.org/author/Jeroen-Van-Goey/147072314"><i class="bi bi-mortarboard"></i> Semantic Scholar</a>
</div>
```
...
```{=html}
<script>
// Homepage-only "jump to a section" hamburger: a dropdown appended to the
// right-aligned navbar list, so it sits in the top-right corner and its menu
// (dropdown-menu-end) opens fully on-screen. Lives here (not in _quarto.yml) so
// it appears only on the homepage. Uses Bootstrap's dropdown, which Quarto loads
// and auto-wires for [data-bs-toggle] via event delegation.
document.addEventListener("DOMContentLoaded", () => {
  const rightNav = document.querySelector(".navbar .navbar-nav.ms-auto");
  if (!rightNav || document.getElementById("section-menu")) return;
  const sections = [
  ...
  toggle.setAttribute("aria-label", "Jump to a section");

...
<div class="media-wrap">
  ...
  <div class="coverage">
    ...
    <ul class="coverage-grid">
      <li class="coverage-featured"><a href="https://www.science.org/content/article/ai-revolution-comes-protein-sequencing"><img class="coverage-logo" src="images/icons/science.svg" alt="Science"><span class="headline">An AI revolution comes to protein sequencing</span></a></li>
...
### <img src="images/icons/biomerieux.png" class="company-icon" alt=""> [Applied Maths (acquired by bioMérieux)](https://web.archive.org/web/20201211112011/https://www.applied-maths.com/)
...
<img src="images/icons/howest.png" class="company-icon" alt=""> **HOWEST Hogeschool West-Vlaanderen**\
...
<img src="images/flags/be.svg" class="flag-icon" alt="Belgium">Leuven, Belgium\
...
<img src="images/flags/be.svg" class="flag-icon" alt="Belgium">Antwerp, Belgium\
M.Sc., Biology

<img src="images/icons/universitat-de-barcelona.png" class="company-icon" alt=""> **Universitat de Barcelona**\
<i class="bi bi-calendar3"></i> _2002_\
<img src="images/flags/es.svg" class="flag-icon" alt="Spain">Barcelona, Spain\
Erasmus interuniversity exchange

<img src="images/icons/lillesand.png" class="company-icon" alt=""> **Møglestu videregående skole**\
<i class="bi bi-calendar3"></i> _1996–1997_\
<img src="images/flags/no.svg" class="flag-icon" alt="Norway">Lillesand, Norway\
AFS intercultural exchange program

<img src="images/icons/olv.png" class="company-icon" alt=""> **Onze-Lieve-Vrouwecollege, Antwerp**\
...
**Frameworks**\
<img src="images/icons/pytorch.svg" class="company-icon" alt="">PyTorch, TensorFlow / TFX, NumPy, pandas

**MLOps**\
<img src="images/icons/kubernetes.svg" class="company-icon" alt="Kubernetes"><img src="images/icons/docker.svg" class="company-icon" alt="Docker">Kubernetes-based ML platforms (AIchor), Docker, CI/CD, workflow orchestration (Airflow, Dagster), experiment tracking (MLflow, Neptune, TensorBoard)

**Cloud**\
<img src="images/icons/aws.svg" class="company-icon" alt="AWS"><img src="images/icons/googlecloud.svg" class="company-icon" alt="Google Cloud">Buckets, VMs, Cloud Run (AWS, GCP)
...
**Languages**\
<img src="images/icons/python.svg" class="company-icon" alt="">Python (primary), R

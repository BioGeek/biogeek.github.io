...
<div class="pub-card flagship">
  ...
  <div class="pub-body">
    ...
    <div class="pub-badges">
      ...
      <a href="https://github.com/instadeepai/InstaNovo" title="GitHub stars"><i class="bi bi-star-fill"></i> <!--instanovo-stars-->123<!--/instanovo-stars--> stars</a>
...
- Built the team's **ML engineering foundations**: scalable, Transformer-based libraries (Python / PyTorch) for large-scale training on two of the world's most powerful supercomputers (InstaDeep's **Kyber**, ~500 PFLOPs, and EuroHPC's **MareNostrum 5**, 260 PFLOPs peak), as well as GPUs and the cloud, with training and data pipelines orchestrated in **Dagster**.

...
<div class="hiring">
  <p class="hiring-status"><strong>Currently looking for Staff/Principal Research Engineer roles in AI for science</strong>, especially biology, proteomics, drug discovery, protein design, or scientific foundation models.</p>
  ...
  <ul class="proof">
    <li>Published a diffusion model for <i>de novo</i> peptide sequencing in <strong>Nature Machine Intelligence</strong>.</li>
    <li>Led BioAI teams working on peptide sequencing and signal-peptide design.</li>
    <li>Built scalable ML systems across GPUs, HPC, cloud, and scientific data pipelines.</li>
  </ul>
</div>
```
...
<div class="case-study flagship">
  <div class="cs-head">
    <span class="cs-title">InstaNovo: diffusion-powered <i>de novo</i> peptide sequencing</span>
    <span class="cs-venue">Nature Machine Intelligence · 2025</span>
  </div>
  <dl>
    <dt>Problem</dt>
    <dd>Reading peptide sequences directly from mass-spectrometry spectra without a reference database is a core bottleneck in proteomics, and essential for discovering novel peptides in immunopeptidomics and personalized cancer vaccines.</dd>
    <dt>My role</dt>
    <dd>Part of the InstaDeep BioAI team behind InstaNovo: contributed to model development, large-scale training and evaluation, and co-authored the paper.</dd>
    <dt>Impact</dt>
    <dd>Published in <strong>Nature Machine Intelligence</strong>; surpasses prior state-of-the-art and recovers thousands of previously unidentified peptides. Open-source, with broad independent press (Science, Science News, Chemistry World, and more).</dd>
  </dl>
...
<div class="case-study">
  <div class="cs-head">
    <span class="cs-title">InstaNexus: generalizable direct protein sequencing</span>
    <span class="cs-venue">Molecular &amp; Cellular Proteomics · 2026</span>
  </div>
  <dl>
    <dt>Problem</dt>
    <dd><i>De novo</i> sequencing models often fail to generalize across instruments, organisms and acquisition methods. InstaNexus targets robust, generalizable direct protein sequencing.</dd>
    <dt>My role</dt>
    <dd>Co-author; contributed to model development and evaluation across diverse proteomics datasets.</dd>
    <dt>Impact</dt>
    <dd>Peer-reviewed in <strong>Molecular &amp; Cellular Proteomics</strong>, demonstrating generalization beyond the conditions models were trained on.</dd>
  </dl>
  <div class="pub-badges">
...
<div class="case-study">
  <div class="cs-head">
    <span class="cs-title">Winnow: rescoring &amp; FDR estimation for <i>de novo</i> sequencing</span>
    <span class="cs-venue">arXiv · 2025</span>
  </div>
  <dl>
    <dt>Problem</dt>
    <dd>AI <i>de novo</i> predictions need statistical error control to be trustworthy in practice. Winnow provides rescoring and false-discovery-rate (FDR) estimation for <i>de novo</i> peptide sequencing.</dd>
    <dt>My role</dt>
    <dd>Co-author; contributed to the method and its open-source implementation.</dd>
    <dt>Impact</dt>
    <dd>Released as an open-source tool (<code>winnow-fdr</code> on PyPI) so the wider proteomics community can apply FDR control to <i>de novo</i> results.</dd>
  </dl>
  <div class="pub-badges">

...
<ul class="proof">
  ...
  <li><strong>Reliable, calibrated predictions:</strong> rescoring, calibration and false-discovery-rate control so model outputs carry statistical guarantees (Winnow).</li>

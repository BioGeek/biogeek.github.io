...
<div class="framework">
  ...
  <div class="fw-stages">
    <div class="fw-stage">
      ...
      <div class="fw-sub"><i>De novo</i> sequencing with transformer & diffusion models (InstaNovo / InstaNovo+)</div>
    </div>
    ...
    <div class="fw-stage">
      ...
      <div class="fw-sub">Rescoring, calibration &amp; false-discovery-rate control (Winnow)</div>
    </div>
    <div class="fw-connector"><i class="bi bi-chevron-right"></i></div>
    <div class="fw-stage">
      ...
      <div class="fw-sub">Quantification &amp; structural assembly into biological insight (InstaNexus)</div>
    </div>
  </div>
...
<ul class="proof">
  <li><strong>Independently validated:</strong> top-ranked across an external benchmark of 17 de novo sequencing tools on 83 datasets.</li>
  <li><strong>Built for scale:</strong> distributed training on large public datasets curated with automated LLM labelling.</li>
</ul>
```
...
- Built the team's **ML engineering foundations**: scalable, Transformer-based libraries (Python / PyTorch) for large-scale training across GPUs, HPC supercomputers (MareNostrum v5), and the cloud, with training and data pipelines orchestrated in **Dagster**.
...
<img src="images/flags/be.svg" class="flag-icon" alt="Belgium">BASF and Bayer Crop Science, Belgium\
Trained and mentored researchers and data scientists in scientific Python (NumPy, pandas, BioPython, …) as manager of the Python/R analysis platform used across the scientific community.
...
**Scale & MLOps**\
Distributed GPU training, HPC clusters (on-premise and the MareNostrum 5 supercomputer), Kubernetes-based ML platforms (AIchor), cloud (AWS, GCP), Docker, CI/CD, workflow orchestration (Airflow, Dagster), experiment tracking (MLflow, Neptune, TensorBoard)
